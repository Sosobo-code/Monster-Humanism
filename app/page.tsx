...
export default function Home() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      audioRef.current = new Audio("/drift-mind.mp3")
  ...
  return (
      <AnimatePresence mode="wait">
        {stage === 0 && (
            ...
            >
              <Button onClick={startExperience} variant="ghost" className="text-white border-white hover:bg-white/10">
                Click to Continue
              </Button>
            </motion.div>
        )}
        ...
        {stage === 3 && (
            ...
            >
              <div className="case-file-container w-full max-w-5xl aspect-[4/3] bg-[#e6dcc6] rounded-md shadow-lg p-6 relative overflow-hidden">
                ...
                <h1 className="text-2xl md:text-3xl font-serif text-gray-800 mb-6 mt-4">The Tenma Case</h1>
